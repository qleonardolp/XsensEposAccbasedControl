...
public:
	...
	{
		//ENDERECA E INICIALIZA O FRAME NMT
		char *FRAME = "NMT";
		NMT.initCANFrame(1, "CAN2", l_pSelectedDatabase, l_pSelectedCluster, FRAME); //2

		//ENDERECA E INICIALIZA O FRAME NMT
		SYNC.initCANFrame(1, "CAN2", l_pSelectedDatabase, l_pSelectedCluster, "SYNC"); //2
	}

	//METODO QUE ENVIA O START PARA A TRANSMISSAO DOS PDOS PARA A REDE CAN
	...
	//METODO QUE ENVIA O STOP PARA A TRANSMISSAO DOS PDOS PARA A REDE CAN
	...
	//METODO QUE ENVIA O RESET TODA A COMUNICACAO DA REDE
	void ResetComm()
	{
	...
	//METODO DE DESTRUICAO DA CLASSE
	~EPOS_NETWORK()
	{
	}
