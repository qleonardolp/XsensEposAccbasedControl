...
C(1,1) = -Ka; C(1,2) = Ka; C(3,2) = 1; C(4,3) = N; C(5,4) = 1; C(6,5) = N;
D = zeros(sensor_dim, control_dim); D(2,1) = 1;
...
imu_delay = 8; % [ms]
Sys = ss(A,B,C,D,'TimeUnit','milliseconds','OutputDelay',[0 imu_delay 0 imu_delay 0 0]');
% Discretization
Ts = 1; % [ms]
